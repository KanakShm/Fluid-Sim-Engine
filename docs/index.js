...
// include: C:\Users\kanak\AppData\Local\Temp\tmpmqa9wo8e.js
...
Module['FS_createPath']("/res", "textures", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/shaders/Basic.shader", "start": 0, "end": 469}, {"filename": "/res/shaders/Fluid.shader", "start": 469, "end": 1846}, {"filename": "/res/textures/awesomeface.png", "start": 1846, "end": 61123}, {"filename": "/res/textures/container.jpg", "start": 61123, "end": 246062}], "remote_package_size": 246062});

  })();

// end include: C:\Users\kanak\AppData\Local\Temp\tmpmqa9wo8e.js
// include: C:\Users\kanak\AppData\Local\Temp\tmp6y9fsvi5.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\kanak\AppData\Local\Temp\tmp6y9fsvi5.js
// include: C:\Users\kanak\AppData\Local\Temp\tmpqx1c6bsr.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\kanak\AppData\Local\Temp\tmpqx1c6bsr.js
